...
const restoredTab=typeof savedState.activeTab==='string'?savedState.activeTab:'inline-reviews';const restoredButton=document.querySelector('[data-tab="'+restoredTab+'"]');if(restoredButton)showTab(restoredTab,restoredButton,false);restorePendingReviewOverlays();updateReviewNavigation();
</script>
</body>
</html>`;
  }
