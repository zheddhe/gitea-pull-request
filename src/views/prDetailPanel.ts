...
<script nonce="${nonce}">
const vscode=acquireVsCodeApi();const savedState=vscode.getState()||{};let pendingComments=[];let openFormKey=null;let titleCancelled=false;const originalTitle=${JSON.stringify(pr.title)};
