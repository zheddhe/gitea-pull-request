...
.title-row{display:flex;align-items:center;gap:10px;margin-bottom:5px}.title-row h1{font-size:1.22em;line-height:1.3;font-weight:600;margin:0;overflow-wrap:anywhere}.state-icon{font-size:.85em;line-height:1}.state-open{color:var(--success)}.state-closed{color:var(--danger)}.state-merged{color:var(--merged)}
